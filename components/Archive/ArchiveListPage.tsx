  ...
  return (
    <AnimatePresence initial={false}>
      ...
      {menuOpen ? (
        ...
        >
          ...
          >
            <div className="w-full md:grid md:grid-cols-8">
              ...
              <div className="mb:pb-32 relative top-0 ml-auto w-full self-start pb-20 pt-350 md:col-span-3 md:col-start-5 md:pt-32">
        ...
        <motion.div className="absolute inset-0 z-[2] h-full min-h-screen w-full md:col-span-8  md:pt-0">
          <ReactLenis
            options={{ lerp: 0.5 }}
            className="scrollbar-hidden relative min-h-screen overflow-auto md:h-screen"
          >
