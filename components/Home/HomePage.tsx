    ...
    >
      <div className="col-span-8 w-full text-14 leading-130 md:grid md:grid-cols-8">
        <div className="relative col-span-3 h-full overflow-auto py-20 md:py-32">
          <Header />
          <div className="relative z-[0] flex h-[calc(calc(calc(var(--vh,1vh)*100)-64px)-0.5ch)] items-center justify-center text-[clamp(40px,5vw,56px)] md:h-[calc(calc(calc(var(--vh,1vh)*100)-64px)-1.4ch)]">
            <motion.div
